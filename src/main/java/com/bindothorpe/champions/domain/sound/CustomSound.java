...
//    SKILL_PHASE_WARP_DASH(Sound.ITEM_TRIDENT_RIPTIDE_1, 0.4f, 1.5f),
    SKILL_PHASE_WARP_WARP(Sound.ENTITY_ILLUSIONER_MIRROR_MOVE, 1.0f, 1.8f),
    SKILL_PHASE_WARP_DASH(List.of(Sound.ITEM_TRIDENT_RIPTIDE_1, Sound.ENTITY_PHANTOM_FLAP), List.of(0.4f, 0.2f), List.of(1.5f, 1.2f)),
