...
public enum SkillId {
    ...
    QUICK_STEP(SkillType.PASSIVE_B), ISOLATION(SkillType.PASSIVE_B), STAMPEDE(SkillType.PASSIVE_B), LOTUS_TRAP(SkillType.PASSIVE_A), TEST_SKILL(SkillType.SWORD), FURY(SkillType.SWORD);
